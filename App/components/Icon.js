...
library.add(
    fasUsers, falUsers, falBars, fasCampfire, falCampfire, falArrowAltLeft, falUser, falKey, fasInfoCircle,
    ...
    falPlus, falCalendarWeek, falClock, falCompass, falSyncAlt, falPencilAlt, fasPencil, falPencil
);
