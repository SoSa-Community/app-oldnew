...
const CommentItem = ({ comment, depth, onFacePress }) => {
	...
	Preferences.get('comments:hide_profile_picture', (value) =>
		setHideProfilePicture(Boolean(value)),
	);
	...
	return (
		<View style={Styles.container}>
				...
				<View style={Styles.innerContainer}>
					...
					<View style={Styles.textContainer}>
						<Text style={[Styles.text, heightStyles]}>
							<Text onPress={onFacePress} style={Styles.nickname}>
								{nickname}{' '}
							</Text>
							{getContent}
							{moreContent && (
								<Text
									onPress={() => {
										setContent(
											getShowingFull ? excerpt : content,
										);
										setShowingFull(!getShowingFull);
									}}
									style={Styles.showMoreText}>
									{' '}
									{getShowingFull ? 'show less' : 'show more'}
								</Text>
							)}
						</Text>
					</View>
			...
			{getShowingChildren && (
				<View style={Styles.childrenContainer}>{childViews}</View>
			)}
		</View>
	);
};
