...
const MeetupItem = ({ meetup, onChange, onTellMeMorePress }) => {
	...
	if (meetup.attendees && meetup.attendees.length) {
		hasAttendees = true;
	}
	...
	const attendees = meetup.attendees.map((attendee, index) => {
		return (
			<View style={Styles.attendeeImageContainer} key={index}>
				<FastImage
				...
				<View style={Styles.imageTitleContainer}>
					<View style={Styles.imageTitleInnerContainer}>
						...
						<Text style={Styles.meetupDate}>
							{Helpers.dateToLongForm(meetup.start_timestamp)}
						</Text>
					</View>
				</View>
