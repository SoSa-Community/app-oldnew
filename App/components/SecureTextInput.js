...
const SecureTextInput = ({icon, placeholder, onChangeText, value, enabled, validateInput}) => {
    ...
    const displayViewInput = () => {
        ...
        return <Icon icon={['fal', icon]}  style={[Styles.inputIcon, Styles.viewPasswordIcon]} size={22} color={color} onPress={() => setHideInput(!hideInput)} />
    };
