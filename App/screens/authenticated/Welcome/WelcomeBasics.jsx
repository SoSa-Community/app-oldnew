				...
				<View style={{ flex: 1 }}>
					<View style={{ paddingTop: 32, paddingHorizontal: '5%' }}>
						<View style={{ alignItems: 'center' }}>
							...
							<Text
								...
								Before I can let you in, I need just a little
						...
						<View style={{ marginTop: 32 }}>
							...
							<View style={{ marginTop: 12 }}>
								...
								<TextField
									...
									value={locationInput}
									onChangeText={(data) =>
										this.setState({ locationInput: data })
									}
									enabled={!this.state.saving}
									allowClear={true}
							...
							<View style={{ marginTop: 12 }}>
								...
								<TextField
									...
									value={genderInput}
									onChangeText={(data) =>
										this.setState({ genderInput: data })
									}
									enabled={!this.state.saving}
									type="picker"
								/>
					...
					<View style={{ justifyContent: 'flex-end', flex: 1 }}>
						<View style={{ flexDirection: 'row', height: 40 }}>
							...
							<View style={{ flex: 1, paddingHorizontal: 4 }}>
								<ActivityButton
									showActivity={this.state.saving}
									onPress={() => {}}
									text="Let me in!"
								/>
							</View>
