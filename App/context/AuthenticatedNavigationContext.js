...
const Drawer = forwardRef(
	({ navigator: Navigator, children, ...props }, ref) => {
		const [canSwipe, setCanSwipe] = useState(true);

		useImperativeHandle(ref, () => ({ setCanSwipe }));
		return (
			<Navigator {...props} screenOptions={{ gestureEnabled: canSwipe }}>
				{children}
			</Navigator>
		);
	},
...
const AuthenticatedNavigationProvider = ({
	navigator: Navigator,
	...props
}) => {
...
const useAuthenticatedNavigation = () =>
